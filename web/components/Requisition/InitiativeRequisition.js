    ...
    <>
      ...
      <Card>
        ...
        <Checkboxs>
          <Checkbox
            name="initiatives"
            value="政府機關之組織、職掌、地址、電話、傳真、網址及電子郵件信箱帳號(§7-3)"
          />
          <Checkbox
            name="initiatives"
            value="行政文書、公報、白皮書、書、狀、申請書、申請規定、證明文件、管理要點、參考手冊(§7-4)"
          />
          <Checkbox name="initiatives" value="合議制機關會議紀錄(§7-10)" />
          <Checkbox
            name="initiatives"
            value="施政計畫、業務統計、研究報告(§7-5)"
          />
        </Checkboxs>
        <Text>b.【財務類】應主動公開資訊</Text>
        <Checkboxs>
          <Checkbox name="initiatives" value="預算、決算書(§7-6)" />
          <Checkbox name="initiatives" value="公共工程及採購書面契約(§7-8)" />
          <Checkbox
            name="initiatives"
            value="罰鍰獎金、檢舉獎金、慰問金、活動補助經費、補助款、基金、捐助、撥款、支出(§7-9)"
          />
          <Checkbox
            name="initiatives"
            value="施政計畫、業務統計、研究報告(§7-5)"
        ...
        <Checkboxs>
          <Checkbox
            name="initiatives"
            value="條約、對外關係文書、法律、緊急命令、命令、法規命令、地方自治法規(§7-1)"
          />
          <Checkbox
            name="initiatives"
            value="設置要點、作業原則、作業規定(§7-2)"
          />
          <Checkbox name="initiatives" value="請願處理結果、訴願決定(§7-7)" />
        </Checkboxs>
      </Card>
